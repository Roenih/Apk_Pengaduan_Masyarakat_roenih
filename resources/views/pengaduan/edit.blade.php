                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{$pengaduan->tgl_pengaduan}}" name="tgl_pengaduan" type="date" id="example-date-input">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="example-text-input" class="form-control-label">NIK</label>
                        <input type="number" name="nik" class="form-control" value="{{$pengaduan->nik}}"id="exampleFormControlInput1">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="isi_laporan" id="exampleFormControlTextarea1" rows="3">{{$pengaduan->isi_laporan}}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
